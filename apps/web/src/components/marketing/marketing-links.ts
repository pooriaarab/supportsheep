 ...
 * `app.blogbat.com`. Centralized here so every CTA points at the same place.
 */

/** The dashboard app origin where signup, onboarding, and login live. */
export const APP_URL = "https://app.blogbat.com";
 ...
 * create-your-blog form; the bare app origin (`app.blogbat.com`) is a reserved
