 ...
 * default — so an agent's key only ever touches the knowledge base it was issued for.
 */
export interface McpToolContext {
  /** the knowledge base the API key is bound to. All repo calls scope to this. */
  blogId: string;
