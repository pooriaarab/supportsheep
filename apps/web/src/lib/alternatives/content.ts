...
const NARRATIVES: Record<string, CompetitorNarrative> = {
  ...
  webflow: {
    ...
    faqs: [
      ...
      {
        question: "Is Supportsheep a Webflow alternative for a customer?",
        answer:
          "The honest answer: Webflow is not really in Supportsheep's competitive set. Supportsheep is aimed at non-technical support agents who need a site in minutes. Webflow is aimed at designers and development-adjacent marketers who want full control. If you are a customer without design skills, Supportsheep, Squarespace, or Wix are more appropriate. If you are a freelance designer building client sites, Webflow is the more powerful tool. The product doc's own framing: Supportsheep is an alternative to 'I'll just get it done.'",
      },
    ],
  },
  durable: {
    ...
    chooseCompetitorIf:
      "You want one subscription to cover your website, CRM, invoicing, and marketing tools without stitching together separate services. Durable's bundled CRM tracks client contacts and its invoicing tool is particularly useful for service-based customers who need basic billing. If the bundled tools are genuinely ones you would use, the value density of Durable's Launch plan is hard to beat.",
    faqs: [
      {
  ...
  "wordpress-com": {
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "It can be, especially if you anticipate significant content volume over time. For a service business that primarily needs a few static pages and a contact form with minimal ongoing content, WordPress.com's setup overhead -- picking a theme, configuring the block editor, learning the dashboard -- is more than most customers want. Supportsheep's AI onboarding removes that setup: it generates pages, service descriptions, and copy in one flow and you launch faster. For a therapist, consultant, or tradesperson whose site is primarily a credibility and contact tool, Supportsheep's speed advantage is meaningful.",
      },
      {
  ...
  "sites-google": {
    ...
    faqs: [
      ...
      {
        question: "Is Google Sites a good choice for a freelancer or customer?",
        answer:
          "Almost never. A Google Sites page on a sites.google.com URL signals that the business has not invested in a basic web presence, which undermines the credibility the site is meant to establish. For a freelancer or customer, Supportsheep's free plan with a custom domain, AI-generated professional copy, and a contact form delivers everything a Google Sites page cannot -- at no cost.",
      },
    ],
  },
};
