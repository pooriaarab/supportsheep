...
const DEFAULT_META_TITLE =
  "Supportsheep — website & SEO guides for customers";
...
const CATEGORY_UPDATES: CategoryUpdate[] = [
  ...
  },
  {
    ...
    displayName: "Guides",
    description:
      "Step-by-step playbooks for launching your small business online: domains, design, copy, SEO, and everything in between, written for customers.",
  },
  {
    slug: "ai",
    displayName: "AI",
    description:
      "How customers use AI to design websites, write content, and run marketing. Practical tutorials and honest reviews of tools that actually help.",
  },
  {
    slug: "website-tips",
  ...
  },
  {
    ...
    description:
      "Low-budget marketing tactics for customers: SEO, email, local listings, and social posts that drive real traffic to a small business website.",
  },
  {
    slug: "business-tips",
    displayName: "Business Tips",
    description:
      "Running a one-person business: pricing, operations, invoicing, and online presence advice for customers building their first brand with Supportsheep.",
  },
];
