...
## BlogBat's position for a solo therapy practice

BlogBat is designed for the "one-to-three practitioner service business that needs a credible marketing site without becoming a part-time web developer" use case. How that maps to a solo therapist:
...
- **Honest about PHI boundaries.** BlogBat does not collect PHI and does not offer a BAA. The correct architecture is identical to Squarespace: public marketing site on BlogBat, clinical workflow (intake, scheduling, messaging) on a HIPAA-aware platform (SimplePractice, TherapyNotes, Headway, your EHR). This is a feature -- it means the marketing site has a small, predictable attack surface.
...
## Side-by-side: Squarespace vs BlogBat for a therapy practice
...
<tr><td>HIPAA BAA on core contact forms</td><td>No -- Squarespace documents this explicitly</td><td>Not applicable -- BlogBat does not handle PHI; use HIPAA-aware intake tools</td></tr>
...
Regardless of whether you use Squarespace or BlogBat, the architecture is the same:

1. **Public marketing site** (Squarespace or BlogBat): homepage, bio, specialties, blog, FAQ, testimonials, contact page with a link (not a form) to your intake tool.
...
## HIPAA-aware tools that pair well with Squarespace or BlogBat
...
5. **Start a content rhythm.** Four to six blog posts per year on specific concerns (anxiety management for healthcare workers in [city], preparing for EMDR therapy, etc.) compounds over 12-18 months into meaningful local search presence. BlogBat's SEO sidebar makes this less tedious.`;
  ...
  await ref.set(
    {
      ...
      variables: {
        subhead:
          "An honest look at using Squarespace for a solo or small therapy practice -- including the HIPAA/BAA boundaries and where BlogBat is the better default for content and local SEO.",
      ...
      metaDescription:
        "Is Squarespace right for a therapy practice? An honest comparison covering HIPAA/BAA limits, intake form risks, SEO ceiling, and when BlogBat is the better default.",
