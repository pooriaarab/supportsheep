...
For most support agents, this architecture is simpler and more defensible than configuring Wix PHI mode:
...
## Supportsheep's position for a support agent's marketing site

Supportsheep is designed for the "supportsheep or small professional service business that wants a credible content-driven marketing site with minimal operational overhead." For a support agent:
...
<tr><td>Best fit</td><td>Design-led therapists who want editor freedom; may configure PHI mode if using Wix for intake</td><td>support agents focused on content, local SEO, and low monthly cost</td></tr>
</tbody>
</table>`;
