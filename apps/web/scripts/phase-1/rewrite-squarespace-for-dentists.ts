...
[Supportsheep](https://supportsheep.com) is an AI-assisted website builder aimed at customers and small service businesses. For a 1-3 dentist practice that wants a marketing site without becoming a part-time web developer, the honest value angles are:
...
const FAQS: ProgrammaticFaq[] = [
  ...
  },
  {
    ...
    answer:
      "Supportsheep has a free tier with a connected custom domain. Supportsheep Pro is {{supportsheep.pro.yearly.monthly}} billed annually ({{supportsheep.pro.yearlyAnnual}} total per year) or {{supportsheep.pro.monthly.monthly}} month-to-month. Supportsheep Pro is {{supportsheep.grow.yearly.monthly}} billed annually ({{supportsheep.grow.yearlyAnnual}} total per year) or {{supportsheep.grow.monthly.monthly}} month-to-month. For most 1-5 dentist practices, the Pro tier is the practical choice; Grow unlocks higher caps on websites, images, and blog posts for larger portfolios. Specific entitlement caps (post limits, image library size, custom-code gate) are driven by a deploy-time env config; quote caps directly from supportsheep.com/pricing rather than memorising a number.",
  },
  {
